...
SECRET_KEY = 'django-insecure-7iw_ax3@%tnysl9c)s(2gckq)6d_tztk(=kv#nv==1sohmkv59'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/mnt/c/Users/Herna/Desktop/ESCRITORIO/project_coder_house/project_web'],  
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
